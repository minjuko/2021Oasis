...
제2회 OASIS 해커톤에서 4인 팀으로 개발한 프로젝트입니다.
...
HTML5, CSS3, JavaScript, jQuery를 활용하여 모바일 환경을 기준으로 **카풀 탐색·등록·상세 조회 및 사용자 프로필 화면**을 구현했습니다.
...
<p>
  <img width="200" height="350" alt="카풀 목록 화면" src="docs/images/carpool-list.PNG">
  <img width="200" height="350" alt="카풀 등록 화면" src="docs/images/carpool-new.PNG">
  <img width="200" height="350" alt="카풀 상세 및 TMAP 경로 조회 화면" src="docs/images/carpool-tmap-detail.PNG">
</p>

| 화면 | 주요 기능 |
| --- | --- |
| 카풀 목록 | 카풀 탐색 및 조건 검색 |
| 카풀 등록 | 출발지·목적지 등 모집 정보 등록 |
| 카풀 상세 | 모집 정보 및 TMAP 이동 경로 확인 |
